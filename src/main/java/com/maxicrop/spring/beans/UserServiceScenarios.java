 ...
 * 
 */
public class UserServiceScenarios extends JUnitStories {

	private final CrossReference xref = new CrossReference();

	public UserServiceScenarios() {
		super();
		...
		this.configuredEmbedder().reportStepdocs();
	}
	...
	public List<String> storyPaths() {
		return Arrays.asList("com/maxicrop/spring/beans/Math.story");
	}

	@Override
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(), new UserServiceStep());
	}
